...
public class FlowchartPanelPrintable implements Printable {
	FlowchartPanel fPanel;
	BufferedImage[] images;

	public FlowchartPanelPrintable(FlowchartPanel p, PageFormat pageFormat) {
		fPanel = p;
		images = null;
	}
