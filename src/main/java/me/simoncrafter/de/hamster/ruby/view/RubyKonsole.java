package me.simoncrafter.de.hamster.ruby.view;
...
import me.simoncrafter.de.hamster.scheme.view.JMyTextArea;
import me.simoncrafter.de.hamster.workbench.Utils;
import me.simoncrafter.de.hamster.workbench.Workbench;

/**
 * Diese Klasse stellt eine JFrame als Konsole f�r Ruby-Code dar.
 */
public class RubyKonsole extends JFrame implements ActionListener,
	...
	private void initKonsole() {
		...
		try {
			...
			command += "include_class \"me.simoncrafter.de.hamster.ruby.model.RubyHamster\"\n";
