package me.simoncrafter.de.hamster.python.view;
...
/**
 * Diese Klasse stellt eine JFrame als Konsole f�r Python-Code dar.
 */
public class PythonKonsole extends me.simoncrafter.de.hamster.console.Console {
	...
	public void init() {
		...
		String command = "from me.simoncrafter.de.hamster.python.model import PythonHamster;";
