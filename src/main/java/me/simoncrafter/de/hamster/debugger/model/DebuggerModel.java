...
import me.simoncrafter.de.hamster.flowchart.controller.FlowchartHamster;
...
import me.simoncrafter.de.hamster.python.model.PythonHamster;
import me.simoncrafter.de.hamster.ruby.model.RubyHamster;
import me.simoncrafter.de.hamster.scheme.model.SchemeHamster;
import me.simoncrafter.de.hamster.scheme.view.SchemeKonsole;
import me.simoncrafter.de.hamster.scratch.ScratchHamster;
import me.simoncrafter.de.hamster.scratch.ScratchHamsterFile;
...
public class DebuggerModel extends Observable implements Runnable {
	...
	public void start(HamsterFile file) {
		...
		if (Utils.runlocally) {
			...
			/* lego */me.simoncrafter.de.hamster.lego.model.LHamster.processor = this.localProcessor;
	...
	private void lockType(ReferenceType ref) {
		...
		if (file != null) {
			...
			if (ref.name().startsWith("java.") || ref.name().startsWith("javax.")
					|| ref.name().startsWith("me.simoncrafter.de.hamster.") || ref.name().startsWith("sun.")) {
				return;
			}
	...
	private void step(int stepDepth) {
		...
		this.stepRequest.addClassExclusionFilter("me.simoncrafter.de.hamster.*");
