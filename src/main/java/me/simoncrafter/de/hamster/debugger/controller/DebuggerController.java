package me.simoncrafter.de.hamster.debugger.controller;
...
import me.simoncrafter.de.hamster.debugger.view.DebuggerTools;
import me.simoncrafter.de.hamster.debugger.view.StackFrameTable;
import me.simoncrafter.de.hamster.debugger.view.VariableViewer;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == ACTION_STEP) {
			if (activeFile != null
				...
				// Falls ein Scheme- oder Python Programm ausgef�hrt wird muss
				// der
				// start-Funktion
				// die workbench mit �bergeben werden.
			...
			// gar nicht m�glich / implementiert
			if (activeFile != null
					&& (activeFile.getType() == HamsterFile.SCRATCHPROGRAM ||
							activeFile.getType() == HamsterFile.FSM ||
							activeFile.getType() == HamsterFile.FLOWCHART
			...
			if (model.getState() == DebuggerModel.PAUSED) {
				...
				// Falls ein Scheme- oder Python Programm ausgef�hrt wird muss
				// der start-Funktion die workbench mit �bergeben werden.
