package me.simoncrafter.de.hamster.compiler.controller;
...
import me.simoncrafter.de.hamster.compiler.model.JavaError;
import me.simoncrafter.de.hamster.compiler.view.CompilerErrorPanel;
import me.simoncrafter.de.hamster.compiler.view.CompilerTools;
...
public class CompilerController implements ActionListener {
	...
	public void setActiveFile(HamsterFile activeFile) {
		...
		if (activeFile == null
			...
			// Das gleiche wie oben gilt auch f�r Prolog-Programme..
			this.compilerTools.setButtonsVisible(false);
			// Python
		} else if (this.activeFile.getType() == HamsterFile.PYTHONPROGRAM) {
			// Das gleiche wie oben gilt auch f�r Python-Programme..
			this.compilerTools.setButtonsVisible(false);
			// Ruby
		} else if (this.activeFile.getType() == HamsterFile.RUBYPROGRAM) {
			// Das gleiche wie oben gilt auch f�r Ruby-Programme..
			this.compilerTools.setButtonsVisible(false);
			// Scratch
		} else if (this.activeFile.getType() == HamsterFile.SCRATCHPROGRAM) {
			// Das gleiche wie oben gilt auch f�r Scratch-Programme..
			this.compilerTools.setButtonsVisible(false);
			// FSM
		} else if (this.activeFile.getType() == HamsterFile.FSM) {
			// Das gleiche wie oben gilt auch f�r FSM-Programme..
			this.compilerTools.setButtonsVisible(false);
			// Flowchart
		} else if (this.activeFile.getType() == HamsterFile.FLOWCHART) {
			// Das gleiche wie oben gilt auch f�r Flowchart-Programme..
			this.compilerTools.setButtonsVisible(false);
		} else if (this.activeFile.getType() == HamsterFile.JAVASCRIPTPROGRAM) {
			// Das gleiche wie oben gilt auch f�r JavaScript
			this.compilerTools.setButtonsVisible(false);
		} else {
