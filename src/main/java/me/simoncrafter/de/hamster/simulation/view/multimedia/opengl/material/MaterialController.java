package me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.material;
 ...
 * @author chris
 *
 * Verwaltet die Materialien. Wichtig f�r das Laden der Texturen, 
 ...
 * "angefordert" und sp�ter dann von der korrekten Stelle aus geladen
 */
public class MaterialController {
	...
	// wir k�nnen die texturen nicht an beliebigen zeitpunkten laden,
    ...
    public void useTextureSet(int[] set, GLAutoDrawable gld, int mainTex) {
        ...
        // das k�mmert sich darum, und schaltet auch nur die ben�tigte Anzahl an Units an:
        
        if (this.useVeryOldGraphicMode) {
        	
            // falls der index g�ltig ist:
    ...
    // durch umstellung auf vertex array so nicht mehr ben�tigt:
