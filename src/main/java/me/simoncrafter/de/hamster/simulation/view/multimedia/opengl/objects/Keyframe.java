 ...
 * @author chris
 * 
 * Keyframe f�r neues Objektformat. Enth�lt Listen mit Vertices, Texturkoordinaten und Normals. 
...
public class Keyframe {
	...
	public void calcNormals(int typ) {
		...
		// rund:
			...
			// alle unn�tig doppelten vertices entfernen:
			this.trimVertexList();
			
			// wir l�schen die smooth normals:
			this.normals = new ArrayList<Vector3f>();
			...
			for (int f = 0; f < this.faces.size(); f++) {
				...
				// auch addieren wir den face-normal auf den normal des n�chsten vertex
			...
			// die smoothnormnals der vetices aufaddiert. jetzt m�ssen w�r die so entstandenden
