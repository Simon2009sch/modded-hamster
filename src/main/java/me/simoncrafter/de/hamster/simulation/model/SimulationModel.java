...
import me.simoncrafter.de.hamster.lego.model.KornDaException;
import me.simoncrafter.de.hamster.lego.model.MaulNichtLeerException;
import me.simoncrafter.de.hamster.model.CreateInstruction;
import me.simoncrafter.de.hamster.model.HamsterException;
import me.simoncrafter.de.hamster.model.HamsterInitialisierungsException;
import me.simoncrafter.de.hamster.model.HamsterInstruction;
import me.simoncrafter.de.hamster.model.Instruction;
import me.simoncrafter.de.hamster.model.InstructionProcessor;
import me.simoncrafter.de.hamster.model.KachelLeerException;
import me.simoncrafter.de.hamster.model.MauerDaException;
import me.simoncrafter.de.hamster.model.MaulLeerException;
import me.simoncrafter.de.hamster.model.TerminalInstruction;
import me.simoncrafter.de.hamster.model.TerrainCellInstruction;
import me.simoncrafter.de.hamster.model.TerrainInstruction;
...
public class SimulationModel extends Observable implements InstructionProcessor {
	...
	public void removeHamster() {
		hamsterList.removeAll(hamsterList);
		setChanged();
		notifyObservers(TERRAIN);
	}
	...
	public synchronized Object processHamsterInstruction(
		...
		// int delay =
		// me.simoncrafter.de.hamster.workbench.Workbench.getWorkbench().getDebugger()
		...
		synchronized (terrain) { // dibo 120907
			...
			if (instruction instanceof CreateInstruction) {
				...
				hamsterList.add(new Hamster(id, ci.getCol(), ci.getRow(), ci
	...
	public synchronized Object processTerrainInstruction(
		...
		synchronized (terrain) { // dibo 120907
			...
			case TerrainInstruction.COUNT_HAMSTER:
				return new Integer(hamsterList.size() + 1);
	...
	public synchronized ArrayList getHamsterIDs() {
		...
		for (int i = 0; i < hamsterList.size(); i++) {
			Hamster h = (Hamster) hamsterList.get(i);
	...
	public synchronized Object newHamster(int id, int r, int s, int b, int k,
		...
		if (terrain.getWall(s, r) || b < 0 || b > 3 || k < 0)
			throw new HamsterInitialisierungsException(null);
		hamsterList.add(new Hamster(id, s, r, b, k, c));
		setChanged();
		notifyObservers(TERRAIN);
		return "ok";
	}
	...
	public synchronized Object newHamster(int id, int r, int s, int b, int k) {
		if (terrain.getWall(s, r) || b < 0 || b > 3 || k < 0)
			throw new HamsterInitialisierungsException(null);
		hamsterList.add(new Hamster(id, s, r, b, k, int_color++));
		setChanged();
		notifyObservers(TERRAIN);
		return "ok";
	}
