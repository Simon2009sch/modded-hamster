...
public class Animation {
	...
	public Animation(Animation a) {
		...
		this.obj = a.getObj(); // das wird �bernommen
	...
	public int getNextKeyFrame() {
		// schwerer, denn hier m�ssen ggf. aniwechsel betrachtet werden:
		...
		if (tempNewKeyframeID >= this.keyframes.size()) {
			...
			if (this.successor == -1) { // aha, wir loopen.
				...
				// aha, wir sind zuende und springen zum planm��igen
				// nachfolger:
