...
public class SimulationTools implements MouseListener, MouseMotionListener {
	...
	public class WallTool extends TerrainTool {
		public WallTool() {
			super(true);
			setImage(Utils.getImage("resources/Wall32.png"));
		}
		public void done() {
	...
	public class DeleteTool extends TerrainTool {
		public DeleteTool() {
			super(true);
			setImage(Utils.getImage("resources/Delete32.gif"));
		}
		public void done() {
	...
	// Prolog
	/**
	 * Aktiviert / Deaktiviert die M�glichkeit zum Editieren im Territorium des 
	 * Simulationssfensters. Das Editieren soll w�hrend der Ausf�hrung eines 
