 ...
 * @date 05.2007
 * 
 * Der OpenGLListener, der die Callbacks f�r die Steuerung der 3D-Ausgabe
 * implementiert. Er ist auch Keyboard- und Maus-Listener f�r den
 * 3D-Canvas.
 */
...
public class OpenGLEventListener implements GLEventListener, KeyListener,
	...
	public void display(GLAutoDrawable gld) {
		...
		// wir f�ttern die kamera mit den korrekten werten
