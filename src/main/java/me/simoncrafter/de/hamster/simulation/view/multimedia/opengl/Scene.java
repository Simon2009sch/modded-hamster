...
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.material.Color;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.material.Material;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.material.MaterialController;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.material.Texture;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.Animation;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.Factory;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.LightAbstract;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.LightDirectional;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.LightPositional;
import me.simoncrafter.de.hamster.simulation.view.multimedia.opengl.objects.MeshAlt;
import me.simoncrafter.de.hamster.simulation.view.multimedia.realtimesimulation.RealtimeSimulation;
import me.simoncrafter.de.hamster.simulation.view.multimedia.sound.*;

/**
 * Diese Klasse enth�lt die Daten f�r die Darstellung der Hamsterwelt und die
 * Positionen. Sie enth�lt die Daten in aufbereiteter Form f�r die Darstellung
 * in 3D. (Interpolierte Hamsterposition, etc.)
 * 
 * Diese Klasse enth�lt die technischen Aspekte der Szene (Kamera etc.),
...
public class Scene implements Observer {
	...
	public Scene(SimulationModel simmodel, DebuggerModel debmodel,
		...
		// hier haben wir einen gl-kontext, k�nnen also die texturen laden
		// lassen:
	...
	public void setPerspectiveCamPosition(float neigung, float rotation,
		...
		// diese werte errechnen sich aus der kartengr��e und zentrieren die
		// karte:
	...
	/**
	 * 
	 * Zeichnet die Szene. Erh�lt Systemzeit als Parameter um Animationen zu
	 * interpolieren.
	 */
	public void draw(GLAutoDrawable gld, long time) {
		...
		// ggf. kamera f�r firstpeson-view anpassen:
		...
		// und die modelviewmatrix wieder in den urspr�nglichen zustand bringen:
