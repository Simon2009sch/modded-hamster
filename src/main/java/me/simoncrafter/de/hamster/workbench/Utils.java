...
import me.simoncrafter.de.hamster.editor.view.ScratchPanelPrintable;
...
//		aset.add(OrientationRequested.LANDSCAPE);
	...
	public static int COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.BLUE;
	...
	public static void loadProperties() {
		try {
			...
			File file = new File("resources/hamster.properties");
			doLoading(p, file);

			String home = System.getProperties().getProperty("user.home");
			if (home != null) {
				file = new File(home + File.separator + "resources/hamster.properties");
				doLoading(p, file);
			}
	...
	public static void doLoading(Properties p, File file) {
		try {
			if (file != null && file.exists() && file.isFile()
				...
				// Scratch
				str = p.getProperty("resources/scratch");
				if (str != null)
					if (str.equals("true")) {
						Utils.SCRATCH = true;
					} else {
				...
				// FSM
				str = p.getProperty("resources/fsm");
				if (str != null)
					if (str.equals("true")) {
						Utils.FSM = true;
					} else {
				...
				// Flowchart
				str = p.getProperty("resources/flowchart");
				if (str != null)
					if (str.equals("true")) {
				...
				if (str != null)
					if (str.toUpperCase().equals("BLAU")
						...
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.BLUE;
					} else if (str.toUpperCase().equals("ROT")
							|| str.toUpperCase().equals("RED")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.RED;
					} else if (str.toUpperCase().equals("GRUEN")
							|| str.toUpperCase().equals("GREEN")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.GREEN;
					} else if (str.toUpperCase().equals("GELB")
							|| str.toUpperCase().equals("YELLOW")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.YELLOW;
					} else if (str.toUpperCase().equals("CYAN")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.CYAN;
					} else if (str.toUpperCase().equals("MAGENTA")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.MAGENTA;
					} else if (str.toUpperCase().equals("ORANGE")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.ORANGE;
					} else if (str.toUpperCase().equals("PINK")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.PINK;
					} else if (str.toUpperCase().equals("GRAU")
							|| str.toUpperCase().equals("GRAY")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.GRAY;
					} else if (str.toUpperCase().equals("WEISS")
							|| str.toUpperCase().equals("WHITE")) {
						Utils.COLOR = me.simoncrafter.de.hamster.debugger.model.Hamster.WHITE;
					}
				me.simoncrafter.de.hamster.debugger.model.Hamster.$i$defColor = Utils.COLOR;
			}
		} catch (Exception exc) {
		}
