package me.simoncrafter.de.hamster.interpreter;
...
public class Hamster {
	...
	public void init(int reihe, int spalte, int blickrichtung, int anzahlKoerner)
		...
		} catch (me.simoncrafter.de.hamster.model.HamsterNichtInitialisiertException exc) {
			Workbench
					.getWorkbench()
					.getSimulationController()
					.getLogPanel()
	...
	public void vor() throws HamsterNichtInitialisiertException,
		...
		} catch (me.simoncrafter.de.hamster.model.MauerDaException exc) {
			Workbench.getWorkbench().getSimulationController().getLogPanel()
					.logEntry(
							"vor()",
		...
		try {
			...
			Workbench.getWorkbench().getSimulationController().getLogPanel()
					.logEntry("gib()", "HamsterNichtInitialisiertException()",
							true, this._intern_id);
			throw new HamsterNichtInitialisiertException(this);
		} catch (me.simoncrafter.de.hamster.model.MaulLeerException exc) {
			Workbench.getWorkbench().getSimulationController().getLogPanel()
		...
		try {
			...
			Workbench.getWorkbench().getSimulationController().getLogPanel()
					.logEntry("nimm()", "HamsterNichtInitialisiertException()",
							true, this._intern_id);
			throw new HamsterNichtInitialisiertException(this);
		} catch (me.simoncrafter.de.hamster.model.KachelLeerException exc) {
			Workbench.getWorkbench().getSimulationController().getLogPanel()
					.logEntry(
							"nimm()",
	...
	public int getReihe() throws HamsterNichtInitialisiertException {
		try {
			checkInit("getReihe()");
			me.simoncrafter.de.hamster.simulation.model.Hamster h = Workbench.getWorkbench()
	...
	// } else {
	// me.simoncrafter.de.hamster.simulation.model.Hamster hThis = _intern_simulationModel
	// .getHamster(this._intern_id);
	// me.simoncrafter.de.hamster.simulation.model.Hamster hOther = _intern_simulationModel
	...
	public String toString() {
		...
		if (!this._intern_init) {
			...
			int a = 0;
			String b = "";
			me.simoncrafter.de.hamster.simulation.model.Hamster hThis = Workbench
