...
/**
 * Repr�sentation des Standard-Hamsters als Scratch-Hamster
 * 
 * @author dibo
 * 
 */
public class ScratchHamster extends Hamster {
	 ...
	 * 
	 * @param file
	 *            die auszuf�hrende Datei/Programm
	 */
	...
	/**
	 * Wird aufgerufen, wenn der Nutzer w�hrend das Programm pausiert den
	 * Start-Button klickt
	 */
