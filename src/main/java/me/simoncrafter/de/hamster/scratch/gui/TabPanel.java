...
public class TabPanel extends JPanel implements RefreshHandler,
	...
	private void loadImages() {
		...
		TabPanel.imgTop = ScratchUtils.getImage("resources/scratch/backgrounds/top.png");
		TabPanel.imgBottom = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom.png");
		...
		TabPanel.imgTopLeft = ScratchUtils
				.getImage("resources/scratch/backgrounds/top_left.png");
		TabPanel.imgTopRight = ScratchUtils
				.getImage("resources/scratch/backgrounds/top_right.png");
		TabPanel.imgBottomLeft = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom_left.png");
		TabPanel.imgBottomRight = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom_right.png");
	}
