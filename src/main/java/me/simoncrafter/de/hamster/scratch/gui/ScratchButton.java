...
import me.simoncrafter.de.hamster.scratch.ScratchUtils;
...
public class ScratchButton extends JButton implements MouseListener {
	...
	private void loadImages() {
		...
		imgButton = ScratchUtils.getImage("resources/scratch/buttons/button.png");
		imgButtonR = ScratchUtils.getImage("resources/scratch/buttons/button_r.png");
		imgButtonHovered = ScratchUtils.getImage("resources/scratch/buttons/button_hover.png");
		imgButtonRHovered = ScratchUtils.getImage("resources/scratch/buttons/button_r_hover.png");
		imgButtonClickedT1 = ScratchUtils.getImage("resources/scratch/buttons/button_click_type1.png");
		imgButtonClickedT2 = ScratchUtils.getImage("resources/scratch/buttons/button_click_type2.png");
		imgButtonClickedT3 = ScratchUtils.getImage("resources/scratch/buttons/button_click_type3.png");
		imgButtonRClickedT1 = ScratchUtils.getImage("resources/scratch/buttons/button_r_click_type1.png");
		imgButtonRClickedT2 = ScratchUtils.getImage("resources/scratch/buttons/button_r_click_type2.png");
		imgButtonRClickedT3 = ScratchUtils.getImage("resources/scratch/buttons/button_r_click_type3.png");
		imgButtonT1 = ScratchUtils.getImage("resources/scratch/buttons/button_type1.png");
		imgButtonT2 = ScratchUtils.getImage("resources/scratch/buttons/button_type2.png");
		imgButtonT3 = ScratchUtils.getImage("resources/scratch/buttons/button_type3.png");
	}
