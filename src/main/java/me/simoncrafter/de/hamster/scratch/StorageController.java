...
public class StorageController {
	...
	/**
	 * F�gt eine neue boolean-Methode hinzu. Der name darf noch nicht vorhanden
	 * sein.
	 * 
	 * @param name
	 */
	...
	/**
	 * �berpr�ft, ob der �bergebene Name noch nicht vergeben ist oder wirft eine
	 * Exception mit der passenden Fehlerbeschreibung. Es wird dabei der name
	 * jedoch noch nicht registriert, sodern dient nur der reinen �berpr�fung.
	 * 
	 * @param name
	...
	/**
	 * �berpr�ft, ob die Methode mit dem �bergebenen Namen im Programm verwendet
	 * wird.
	 * 
	 * @param name
	 ...
	 * 
	 * @param writer
	 *            Der writer, der bereits das Startelement enth�lt.
