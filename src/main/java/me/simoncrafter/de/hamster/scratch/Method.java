...
import me.simoncrafter.de.hamster.scratch.elements.RootBooleanObject;
import me.simoncrafter.de.hamster.scratch.elements.RootVoidObject;
...
public class Method {
	 ...
	 * m�ssen alle Kinderknoten des Elements <tt>METHOD</tt> �bergeben werden
	 * 
	 * @param childNodes
	 */
	...
	/**
	 * Schreibt den Inhalt dieser Methode in den �bergebenen Buffer
