...
public class ElementListButton implements MouseListener, MouseMotionListener {
	...
	private void loadImages() {
		...
		imgLeft = ScratchUtils.getImage("resources/scratch/buttons/create_button_l.png");
		imgMiddle = ScratchUtils.getImage("resources/scratch/buttons/create_button_m.png");
		imgRight = ScratchUtils.getImage("resources/scratch/buttons/create_button_r.png");
		imgLeftHover = ScratchUtils.getImage("resources/scratch/buttons/create_button_l_hover.png");
		imgMiddleHover = ScratchUtils.getImage("resources/scratch/buttons/create_button_m_hover.png");
		imgRightHover = ScratchUtils.getImage("resources/scratch/buttons/create_button_r_hover.png");
	}
