...
public class ScratchScrollBar extends JComponent implements MouseListener, MouseMotionListener {
	...
	private void loadImages() {
		...
		imgTop = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bg_top.png");
		imgBottom = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bg_bottom.png");
		imgLeft = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bg_left.png");
		imgRight = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bg_right.png");
		imgMiddle = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bg.png");
		imgBarTop = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bar_top.png");
		imgBarBottom = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bar_bottom.png");
		imgBarLeft = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bar_left.png");
		imgBarRight = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bar_right.png");
		imgBarMiddle = ScratchUtils.getImage("resources/scratch/backgrounds/scrollbar/bar.png");
	}
