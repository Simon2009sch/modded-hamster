 ...
 * erkannt, das die zugrunde liegende XML-Datei den Tag "<SCRATCHPROGRAM>" enth�lt
 * 
 * @author dibo
 * 
 */
public class ScratchHamsterFile extends HamsterFile {
	...
	/**
	 * Liest eine XML-Datei ein und liefert das darin repr�sentierte
	 * Scratch-Programm
	 * 
	 * @param xmlFile
	 * @return
	...
	// diese Methode muss angepasst werden
	/**
	 * Generiert zu einem Scratch-Programm eine XML-Repr�sentation und liefert
	 * diese als String
	 * 
	 * @param program
	 * @return
