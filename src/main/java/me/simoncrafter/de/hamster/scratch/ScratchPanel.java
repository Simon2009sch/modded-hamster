...
import me.simoncrafter.de.hamster.scratch.elements.BooleanObject;
import me.simoncrafter.de.hamster.scratch.elements.BooleanPrintRoot;
import me.simoncrafter.de.hamster.scratch.elements.VoidPrintRoot;
import me.simoncrafter.de.hamster.scratch.elements.voids.ReturnBooleanObject;
import me.simoncrafter.de.hamster.scratch.gui.ClickHandler;
import me.simoncrafter.de.hamster.scratch.gui.ContextMenu;
import me.simoncrafter.de.hamster.scratch.gui.ContextMenuHandler;
import me.simoncrafter.de.hamster.scratch.gui.DeleteMethodException;
import me.simoncrafter.de.hamster.scratch.gui.ElementList;
import me.simoncrafter.de.hamster.scratch.gui.InvalidIdentifierException;
import me.simoncrafter.de.hamster.scratch.gui.LocationChangeHandler;
import me.simoncrafter.de.hamster.scratch.gui.MenuItem;
import me.simoncrafter.de.hamster.scratch.gui.MethodChangeHandler;
import me.simoncrafter.de.hamster.scratch.gui.NextMethodHandler;
import me.simoncrafter.de.hamster.scratch.gui.OptionsPanel;
import me.simoncrafter.de.hamster.scratch.gui.RefreshHandler;
import me.simoncrafter.de.hamster.scratch.gui.RenameFunctionFrame;
import me.simoncrafter.de.hamster.scratch.gui.RenameMethodException;
import me.simoncrafter.de.hamster.scratch.gui.ScratchScrollBar;
import me.simoncrafter.de.hamster.scratch.gui.SwapFunctionFrame;
import me.simoncrafter.de.hamster.scratch.gui.TabButton;
import me.simoncrafter.de.hamster.scratch.gui.TabChangedHandler;
import me.simoncrafter.de.hamster.scratch.gui.TabOpenedHandler;
import me.simoncrafter.de.hamster.scratch.gui.TabPanel;
...
public class ScratchPanel extends JPanel implements MouseListener,
	...
	private boolean panelLocked = false; // dibo 290710
	...
	/**
	 * Liefert alle Elemente, die am RootElement h�ngen als Bild zur�ck. Sollten
	 * keine Elemente am RootElement angedockt sein, so wird null
	 * zur�ckgeliefert.
	 * 
	...
	private void loadImages() {
		...
		ScratchPanel.imgTop = ScratchUtils
				.getImage("resources/scratch/backgrounds/top_elementlist.png");
		ScratchPanel.imgBottom = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom_elementlist.png");
		ScratchPanel.imgLeft = ScratchUtils
				.getImage("resources/scratch/backgrounds/left.png");
		ScratchPanel.imgRight = ScratchUtils
				.getImage("resources/scratch/backgrounds/right.png");
		ScratchPanel.imgTopLeft = ScratchUtils
				.getImage("resources/scratch/backgrounds/top_left_elementlist.png");
		ScratchPanel.imgTopRight = ScratchUtils
				.getImage("resources/scratch/backgrounds/top_right_elementlist.png");
		ScratchPanel.imgBottomLeft = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom_left_elementlist.png");
		ScratchPanel.imgBottomRight = ScratchUtils
				.getImage("resources/scratch/backgrounds/bottom_right_elementlist.png");
	}
	...
	public void setTextArea(TextArea area) {
		this.textArea = area;
		((ScratchHamsterFile)this.textArea.getFile()).getProgram()
				.addRefreshHandler(this);
		((ScratchHamsterFile) this.textArea.getFile()).getProgram()
				.addNextMethodHandler(new OnNextMethodHandler());
	...
	public StorageController getStorageController() {
		StorageController c = ((ScratchHamsterFile) this.textArea.getFile())
	...
	public void setLocked(boolean locked) {
		...
		this.elements.setLocked(locked);
		if (locked) {
	 ...
	 * diese Methode verwendet, um w�hrend des dockVorgang berechnet, an welches
	 * Objekt angedockt werden kann.
	 * 
	 * @param r
	 */
	 ...
	 * anzupassen, dass diese bis zu der maximalen H�he gescrollt werden k�nnen.
	 * 
	 * @return
	 */
	...
	/**
	 * Pr�ft, ob der �bergebene JavaIdentifier f�r eine neue Methode m�glich
	 * ist.
	 * 
	 * @param name
	...
	/**
	 * �ffnet ein ContextMenu an der �bergebenen Position, das das �bergebene
	 * Renderable bearbeiten soll.
	 * 
	 * @param elem
	 ...
	 * ver�ndert. Dabei wird der sichtbare Bereich abh�ngig von der Position des
	 * Scrollbakens verschoben.
	 * 
	 * @author HackZ
	 * 
	 */
	 ...
	 * Dieser ClickHandler wird an das ContextMenu �bergeben und die darin
	 * enthaltene Methode onClick wird aufgerufen, wenn auf das MenuItem
	 * "l�schen" geklickt wurde. Dies soll das Element mit dem Namen l�schen,
	 * wenn es nirgendwo gebraucht wurde.
	 * 
	 * @author HackZ
	 * 
	 */
	...
	/**
	 * Dieser Handler sorgt daf�r, dass neu ge�ffnete Tabs im StorageController
	 * als offen markiert werden und geschlossene Tabs als geschlossen. Das
	 * enablet auch den Speichernbutton, da die offenen Tabs mitgespeichert
	 * werden.
	 * 
	 * @author HackZ
	 * 
	...
	class OpenedMethodHandler implements TabOpenedHandler {
		public void tabOpened(String name, boolean opened) {
			...
			ScratchPanel.this.modified();
		}
	}

	/**
	 * Dieser Handler wird an den StorageController �bergeben, der die darin
	 * enthaltene Methode nextMethod aufruft, falls bei Schrittweiser Ausf�hrung
	 * der Tab ge�nder werden soll.
	 * 
	 * @author HackZ
	 * 
	 */
