...
public class TabButton implements MouseListener {
	...
	private void loadImages() {
		...
		imgLeft = ScratchUtils.getImage("resources/scratch/buttons/tab_l.png");
		imgRight = ScratchUtils.getImage("resources/scratch/buttons/tab_r.png");
		imgMiddle = ScratchUtils.getImage("resources/scratch/buttons/tab_m.png");
		imgLeftHovered = ScratchUtils.getImage("resources/scratch/buttons/tab_l_hover.png");
		imgRightHovered = ScratchUtils.getImage("resources/scratch/buttons/tab_r_hover.png");
		imgMiddleHovered = ScratchUtils.getImage("resources/scratch/buttons/tab_m_hover.png");
	}
