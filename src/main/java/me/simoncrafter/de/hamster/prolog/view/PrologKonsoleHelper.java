...
/**
 * Diese Klasse hat die Funktion eines "W�chters" �ber die korekkte
 ...
 * dazu k�mmert sich die Klasse um die Aktualisierung des Zeilenpr�fixes ([break
...
public class PrologKonsoleHelper extends Thread {
	 ...
	 * darauffolgend die Aktualisierung des Zeilenpr�fixes.
	 */
	...
	public void run() {
		while (!terminate) {
			try {
				synchronized (this) {
					if (endOfQuery) {
						...
						if (lastLines[0] != null
							...
							/*
							 * F�ge gem�� dem aktuellen Zustand entsprechends
							 * Query-Pr�fix hinzu.
							 */
				...
				/*
				 * Pr�fe zur Sicherheit nach, ob der Prolog-Interpreter-Process
				 * noch weiterhin ordnungsgem�� ausgef�hrt wird. Falls nicht,
				...
				/*
				 * Nochmals ide Checkbox f�r die PrologKonsole �berpr�fen. Dies
				 * ist notwendig, da PrologKonsole durchaus fr�her erstellt
