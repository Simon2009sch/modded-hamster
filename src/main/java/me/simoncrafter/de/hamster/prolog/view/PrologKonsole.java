package me.simoncrafter.de.hamster.prolog.view;
 ...
 * Prolog-Interpreter aus dem Hamster-Simulator. F�r alle aus dem Programm
...
public class PrologKonsole extends JFrame {
	...
	/**
	 * Die zum Textfeld hinzugeh�rige Scrollpane.
	 */
	...
	/**
	 * Creep-Action Button - �quivalent zum 'Enter' im 'trace'-Modus
	 */
	private JButton creepButton;

	/**
	 * Skip-Aktion Button - Springe zum n�chsten Ziel (im 'trace'-Modus)
	 */
	...
	/**
	 * Speichert die Startposition f�r die Eingabe (neuer) Befehle innerhlab des
	...
	/**
	 * Die zuletzt zum Textfeld(area) hinzugef�gte Zeile.
	 */
	private String lastAddedLine;

	/**
	 * Hilfs-Thread zur Verwaltung der "Zeilen-Pr�fixe". Zust�ndig
	 * ausschlie�lich nur f�r optische Aufbereitung der Ausgaben in der
	 * Prolog-Konsole.
	 */
	private PrologKonsoleHelper helperThread;

	/**
	 * Schlater f�r den Tracing und Debugging Modien.
	 */
	...
	/**
	 * Gibt an, das Ziel f�r das Tracing angegeben wurde, oder nicht.
	 */
	private boolean traceGoalIsSetted;

	/**
	 * Spechert eine endliche Liste der vom Benutzer eingegebenen
	 * Konsolenbefehle. Die Gr��e der Liste wird durch die Konstante
	...
	/**
	 * Nummer des gerade (vor)selektiernten Konsolenbefehls (Selektierung �ber
	...
	/**
	 * F�gt eine neue Zeile zur Textarea in der PrologKonsole hinzu.
	 */
	public synchronized void addLine(final String line) {
		...
		updateGUI(new Runnable() {
			public void run() {
				...
				// Aktualisiere die Text-Start-Position (wichtig f�r die neuen
				// Eingaben)..
	...
	public synchronized void execute(String command, String toConsole) {
		/*
		 * Halte fest, wenn beim �bergang in den Tracing-Modus die eigentliche
		 ...
		 * Darstellung des Befehls f�r die Konsole an. In diesem Fall ist es
		...
		/*
		 * Ein vom Benutzer eingetippter Befehl wird gerade ausgef�hrt.
		 */
		else {
			// F�ge den Benutzerbefehl der History hinzu..
	...
	/**
	 * F�hrt �ber die SwingUtilities GUI-relevante Anweisungen aus.
	 * 
	 * @param doRun
	 ...
	 * der TextArea gef�llt. Alle nachfolgenden Eintr�ge entsprechend mit den
	 * n�chst H�heren..
	 * 
	 * @param count
	...
	/**
	 * Liefert die letzte Eingabe des Benutzers. R�ckgabewert kann nicht null
	...
	/**
	 * F�gt ein History-Eintrag zur Textarea der PrologKonsole hinzu.
	 * 
	 * @param command
	...
	/**
	 * Liefert den n�chsten History-Eintrag (von 0 bis n) und inkrementiert den
	 * Eintrag-Zeiger.
	 * 
	 * @return n�chster History-Eintrag.
	 */
	...
	/**
	 * F�gt ein Eintrag zur History-HamsterCommand-Liste hinzu. Bei gleichen Eintr�gen
	 * wird lediglich die Reihenfolge ge�ndert. Beim �berschreiten der maximal
	 * zul�ssigen Listen-Gr��e wird der am seltensten verwendete Eintrag
	 * entfernt, sodass die Listen-Gr��e gleich bleibt.
	 * 
	 * @param command
	 *            Nutzer-Befehl.
	 */
	public void addToHistory(String command) {
		...
		// Gro�e ist bereits �berschritten..
		else {
			// Pr�fe, ob bereits drin ist..
	...
	/**
	 * Listet die Eintr�ge der HamsterCommand History auf der Konsole auf.
	 */
