package me.simoncrafter.de.hamster.prolog.model;
...
/**
 * Diese Klasse repr�sentiert einen Prolog-Hamster. Sie implementiert alle 
 * Basisbefehle des Hamsters und stellt diese dem Programmierer zur Verf�gung.
 * Es kann ausschlie�lich nur ein einziger Prolog-Hamster (Instanz) zur selben
 * Zeit existieren. 
 */
public class PrologHamster extends Hamster
{
	 ...
	 * Hamsterbefehle und dem Aufr�hmen in der Prolog-Datenbank erfolgt der Export des aktuellen
	 * Hamster-Territoriums ins Prolog. Jegliche Konsolen-Ausgaben w�hrend der Export-Aktion
	 * werden ausgeblendet.
	 */
	 ...
	 * 
	 * @param file Hamsterfile vom Typ 'PROLOGPROGRAMM', welches ausgef�hrt werden soll.
	 */
	...
	/**
	 * Erm�glicht von der Prolog-Engine aus ein Hamsterbefehl mit Exception-Handling
	 * auszuf�hren. Die eventuell Aufgetretenen exceptions werden selbst nicht weiter 
	 * an Prolog gereicht. Es wird lediglich ein boolean, als Statuswert der Aktions-
	 * ausf�hrung zur�ckgegeben.
	 * 
	 ...
	 * Dabei werden werden unterschiedliche Pr�dikate der Prolog-Datenbank
	 * hinzugef�gt.
	 */
	public void exportTerrain() {
		...
		// Hamster - Term.
		me.simoncrafter.de.hamster.simulation.model.Hamster hamster = terrain.getDefaultHamster();
	...
	/**
	 * Entfernt alle hamsterrelevante Pr�dikate aus der Prolog-Datenbank.
	 */
	public void cleanUp() 
	{
	...
	public void updateMauern()
	{
		...
		PrologController.get().execute(ladeAnweisung+".");
		/*
		 * Aufgrund dessen, dass W�nde auch K�rner "�berschreiben,
		 * 0�ssen die Koerner ebenfalls aktualisiert werden.
		 */
		updateKoerner();
	}
