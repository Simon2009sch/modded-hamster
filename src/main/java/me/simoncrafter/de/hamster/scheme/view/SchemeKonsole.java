package me.simoncrafter.de.hamster.scheme.view;
...
import me.simoncrafter.de.hamster.ruby.view.RubyKonsole;
...
/**
 * Diese Klasse stellt eine JFrame als Konsole f�rs Scheme-Code dar. Es besteht
 * aus einem eingabe und einem ausgabe felt und nimmt s�mtliche Scheme-Befehle
...
public class SchemeKonsole extends JFrame implements ActionListener,
	...
	/**
	 * Diese Funktion l�scht den Inhalt des Eingabe- und Ausgabe-Felds
	 */
	...
	/**
	 * F�gt dem Speicher die die display-Funktionen text hinzu.
	 * 
	 * @param text
	 *            Auszugebener Text
	 */
	...
	/**
	 * F�hrt die entsprechenden Funktion be einer Eingabe aus.
	 */
	...
	private static void initKonsole() {
		String s = "(define (read)(me.simoncrafter.de.hamster.scheme.model.SchemeHamster.read))";
		SchemeHamster.getJS().load(s);
		s = "(define (display text)(me.simoncrafter.de.hamster.scheme.model.SchemeHamster.display text))";
		SchemeHamster.getJS().load(s);
