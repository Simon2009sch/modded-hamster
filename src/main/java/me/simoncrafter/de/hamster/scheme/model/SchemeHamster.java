package me.simoncrafter.de.hamster.scheme.model;
...
import me.simoncrafter.de.hamster.scheme.view.SchemeKonsole;
...
/**
 * Diese Klasse repr�sentiert den Scheme-Hamster. Es wird die eine abgewandelte
...
public class SchemeHamster extends Hamster { // dibo 18.02.2010
	...
	// Arbeitsbereich des Simulators, n�tig um andere Komponenten zu erreichen.
	...
	/**
	 * Nicht-�ffentlicher Konstruktor. Es gibt nur eine Instanz des
	 * Schemehamsters. *
	 */
	...
	public static void go() {
		...
		try {
			...
			if (!me.simoncrafter.de.hamster.debugger.model.DebuggerModel.isStop) {
				// Fenster mit Fehlermeldung erzeugen
				// new SchemeExceptionPanel(e.getMessage());
				JOptionPane.showMessageDialog(null, e.getMessage(),
						"Scheme-Exception", JOptionPane.ERROR_MESSAGE, null);
			}
			me.simoncrafter.de.hamster.debugger.model.DebuggerModel.isStop = false;
		}

	}

	private static void initProgram() {
		String s = "(define (read)(me.simoncrafter.de.hamster.scheme.model.SchemeHamster.readP))";
		SchemeHamster.getJS().load(s);
		s = "(define (display text)(me.simoncrafter.de.hamster.scheme.model.SchemeHamster.displayP text))";
		SchemeHamster.getJS().load(s);
		s = "(define (newline)(me.simoncrafter.de.hamster.scheme.model.SchemeHamster.displayP \"\n\"))";
		SchemeHamster.getJS().load(s);
	}
	...
	/**
	 * Diese Funktion bildet die Scheme-display_Funktion f�r den
	 * Hamster-Simulator.
	 * 
	 * @param obj
	 *            Anzuzeigender Text
	...
	public static void display(Object obj) {
		// den anzuzeigenden Text der Konsole hinzuf�gen
	...
	/**
	 * Diese Funktion bildet die Scheme-read-Funktion f�r den Hamster-Simulator
	 * 
	 ...
	 * daraus die ben�tigte Datenstruktur f�r den Scheme-Hamster.
	 * 
	...
	public static SchemePair getTerritorium() {
		...
		me.simoncrafter.de.hamster.simulation.model.Hamster ham = workbench.getSimulation()
	...
	public static SchemePair setTerritorium(SchemePair terrList) {
		...
		me.simoncrafter.de.hamster.simulation.model.Hamster defHamster = terr
				.getDefaultHamster();
		...
		if (reihen != terr.getHeight()) {
			throw new RuntimeException("falsche Territoriumsgr��e");
		}
