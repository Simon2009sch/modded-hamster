package me.simoncrafter.de.hamster.fsm.model;
...
import me.simoncrafter.de.hamster.fsm.controller.handler.DeleteObjectInContextMenu;
import me.simoncrafter.de.hamster.fsm.controller.handler.RenameObjectInContextMenu;
import me.simoncrafter.de.hamster.fsm.view.ContextMenuPanel;
...
public class CommentObject extends RenderableObject{
	...
	public List<JMenuItem> getContextMenuItems(ContextMenuPanel panel) {
		...
		JMenuItem deleteComment = new JMenuItem("Kommentar l�schen");
		deleteComment.addActionListener(new DeleteObjectInContextMenu(this, panel));
		menuItemList.add(deleteComment);
		
		JMenuItem renameComment = new JMenuItem("Kommentartext �ndern");
