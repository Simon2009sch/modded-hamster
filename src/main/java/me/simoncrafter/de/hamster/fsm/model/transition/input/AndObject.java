package me.simoncrafter.de.hamster.fsm.model.transition.input;

import me.simoncrafter.de.hamster.fsm.controller.FsmProgram;
import me.simoncrafter.de.hamster.fsm.model.FsmObject;
import me.simoncrafter.de.hamster.fsm.model.state.IsNondeterministicException;
import me.simoncrafter.de.hamster.fsm.model.transition.BooleanObject;

/**
 * Klasse, die einen Und-Operator für das Objekt im Input eines endlichen Automaten repräsentiert.
 * @author Raffaela Ferrari
 *
 */
public class AndObject extends BooleanObject{
	 ...
	 */
	public AndObject(int positioning) {
		super("und", positioning);
	}

	@Override
	public FsmObject clone() {
		AndObject clonedAndObject = new AndObject(this.positioning);
		clonedAndObject.setChilds(this.childs);
		clonedAndObject.setCoordinates(this.xStart, this.yStart);
		clonedAndObject.setParent(this.parent);
		return clonedAndObject;
	}
