...
import me.simoncrafter.de.hamster.flowchart.FlowchartUtil;
...
import me.simoncrafter.de.hamster.flowchart.model.FlowchartAnchor;
	...
	private void setGhostObject(FlowchartObject flowchartElement) {
		if (!(flowchartElement instanceof DecisionObject)
			...
			this.ghostObject = FlowchartUtil
					.getImage("resources/flowchart/ghost_rect.png");
		} else if (flowchartElement instanceof StartStopObject) {
			this.ghostObject = FlowchartUtil
					.getImage("resources/flowchart/ghost_rectround.png");
		} else {
			this.ghostObject = FlowchartUtil
					.getImage("resources/flowchart/ghost_diam.png");
		}
	}
