...
public class ArrowModeButton implements MouseListener {
	...
	public ArrowModeButton() {
		this.image = FlowchartUtil.getImage("resources/flowchart/arrow.png");
		this.background = FlowchartUtil
				.getImage("resources/flowchart/arrow_background.png");
		this.highlight = FlowchartUtil
				.getImage("resources/flowchart/arrow_highlight.png");
