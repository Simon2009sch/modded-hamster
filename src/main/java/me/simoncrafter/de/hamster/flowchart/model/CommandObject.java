package me.simoncrafter.de.hamster.flowchart.model;
...
public abstract class CommandObject extends FlowchartObject {
	...
	public CommandObject(String command) {
		super();
		setString(command);
		this.image = FlowchartUtil.getImage("resources/flowchart/command.png");
		this.background = FlowchartUtil
				.getImage("resources/flowchart/command_background.png");
		this.highlight = FlowchartUtil
				.getImage("resources/flowchart/command_highlight.png");
