...
public abstract class DecisionObject extends FlowchartObject {
	...
	public DecisionObject(String decision) {
		super();
		setString(decision);
		this.image = FlowchartUtil.getImage("resources/flowchart/decision.png");
		this.background = FlowchartUtil
				.getImage("resources/flowchart/decision_background.png");
		this.highlight = FlowchartUtil
				.getImage("resources/flowchart/decision_highlight.png");
