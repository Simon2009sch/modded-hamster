...
public class StartStopObject extends FlowchartObject {
	...
	public StartStopObject(String name, FlowchartMethod method) {
		super();
		setString(name);
		this.image = FlowchartUtil.getImage("resources/flowchart/start_stop.png");
		this.background = FlowchartUtil
				.getImage("resources/flowchart/start_stop_background.png");
		this.highlight = FlowchartUtil
				.getImage("resources/flowchart/start_stop_highlight.png");
		this.method = method;
