package me.simoncrafter.de.hamster.lego.view;
...
public class LegoTools /*implements Observer*/ {
        ...
        /**
         * Diese Komponente l�st das Kompilieren der Lego-Classdatei, das �bertragen 
        ...
        /**
	 * Der Konstruktor f�gt den Button ein.
	 * 
	 * @param model
