...
import me.simoncrafter.de.hamster.model.*;
 ...
 * starten. 
 * Ist identisch mit der Klasse IHamster, bis auf die Ein- und Ausgabemethoden.
 * Sie erbt aber nicht von dieser, da sie die Methoden im Simulationsmodel selbst 
 * aufrufen muss und die Ein- und Ausgabemethoden nicht nutzbar sein sollen.
 *
...
public class LHamster extends Thread {
        ...
        private void _intern_sleep_200405() {
                try {
                        ...
                        int msec = (int) (Math.random() * 1000 * Thread.NORM_PRIORITY / this
                                .getPriority());
